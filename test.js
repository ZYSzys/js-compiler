...
const tokenizer     = jsCompiler.tokenizer;
const parser        = jsCompiler.parser;
const transformer   = jsCompiler.transformer;
const generator = jsCompiler.generator;
const compiler      = jsCompiler.compiler;
...
assert.deepStrictEqual(generator(newAst), output, 'Code Generator should turn `newAst` into `output` string');
